...
public class PostDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Post post = postDao.getPostsByPostID(pId);

            String[] pPics = post.getpPics();
            ...
            try {
                ...
                if (pPics != null && pPics.length > 0) {
                    ...
                    for (String pPic : pPics) {

                        System.out.println(pPic);
                        Helper.deleteBlogPostFile(dirPath, pPic); // Delete post image

                    }

                }

                if (postDao.deletePost(pId)) {
                    out.print("success");
                } else {
                    out.print("error");
                }
